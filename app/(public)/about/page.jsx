			...
			<section className="w-full bg-gradient-to-b from-zinc-100 via-zinc-50 via-zinc-50 to-white py-12 md:py-24 lg:py-32 text-center">
				<div className="px-4 md:px-6 flex gap-y-4 flex-col">
					...
					<p className="max-w-[600px] m-auto md:text-xl">
						...
						based on the MERN stack and more. Join me on this
					...
					<div className="grid gap-10 sm:px-10 md:gap-16 md:grid-cols-2">
						<div className="space-y-4">
							...
							<p className="mx-auto max-w-[700px] md:text-xl lg:text-base xl:text-xl">
								MERN Stacked is a platform where I share my
								passion for learning, exploring new ideas, and
								empowering my readers. Through a diverse range
								of topics, I aim to inspire and educate my
								community, fostering a love for knowledge and
								personal growth.
							</p>
						</div>
						<div className="flex flex-col items-start space-y-4">
							...
							<p className="mx-auto max-w-[700px] md:text-xl">
								I&apos;m a passionate web developer, driven by a
								curiosity to explore the world of programming.
								With a passion for the MERN stack and JavaScript
								in particular, I&apos;m dedicated to creating
								content that resonates with readers and ignites
								in them the zeal to learn and love the art of
								web development. My goal is to empower and
								inspire others through the power of knowledge.
							</p>
							<Link
								href="/contact"
