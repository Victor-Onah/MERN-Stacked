/**
 * Error UI for when post load fails
 */
export default function ErrorUI() {
	return (
		<div className="min-h-screen bg-white flex justify-center items-center flex-col gap-2 text-red-500">
			<span>
				<svg
			...
			<button
				className="bg-zinc-700 text-white px-8 py-2 rounded-full"
