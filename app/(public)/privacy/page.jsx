		...
		<div className="w-full max-w-3xl mx-auto px-4 md:px-0 py-9 md:py-20">
			<div className="space-y-6">
				...
				<p className="text-muted-foreground text-lg">
					At MERN Stacked, we take your privacy seriously. This policy
					outlines the types of personal information we may collect
					and how we use it.
				</p>
				<div className="space-y-4">
					<div>
						...
						<p className="text-muted-foreground">
							When you interact with the blog, we may collect the
					...
					<div>
						...
						<ul className="list-disc pl-6 space-y-2 mt-4">
							...
							<li>
								Improve the content and functionality of our
								blog
							</li>
					...
					<div>
						...
						<p className="text-muted-foreground">
							...
							and improve our blog. These services may collect
							information about your use of our site, but they are
							required to handle your data in accordance with this
							privacy policy.
						</p>
						<ul className="list-disc pl-6 space-y-2 mt-4">
