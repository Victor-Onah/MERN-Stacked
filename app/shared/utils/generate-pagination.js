/**
 * Generates an array for pagination
 * @param {number} currentPage The current or active page
 * @param {number} threshold The maximum number of pages to be displayed once
