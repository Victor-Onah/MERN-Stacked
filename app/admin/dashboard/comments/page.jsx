					...
					<table class="w-full caption-bottom text-sm">
						...
						<tbody class="[&amp;_tr:last-child]:border-0">
							<tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
								...
								<td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
									I have a question about the topic discussed
									in this post.
								</td>
								<td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
									2023-06-20 11:20 AM
							...
							<tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
								...
								<td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
									Well written and informative. Keep up the
									great work!
								</td>
								<td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
									2023-06-15 2:45 PM
							...
							<tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
								...
								<td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
									I disagree with the author. This post is
									misleading.
								</td>
								<td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
									2023-06-10 9:00 AM
							...
							<tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
								...
								<td class="p-4 align-middle [&amp;:has([role=checkbox])]:pr-0">
									Interesting perspective. I have a different
